...
or you can make request like this with same params:

 POST http://localhost:2002/videos.json

and get an id of video.
Later you can make request like this:

 POST http://localhost:2002/videos/<id>.json

and get info about current state of video file (unencoded, encoding (with progress
in percent), complete)
